...
Status: in progress. Ability-level, promotion, and ascension candidates are supported;
ability coin sufficiency remains explicitly unknown because the Player API export does
not report coin inventory.
